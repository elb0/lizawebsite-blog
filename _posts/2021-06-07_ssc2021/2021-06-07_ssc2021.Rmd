...
description: |
  Notes and links from SSC2021. I often find I get the most from conferences if I take notes with the vague notion of sharing them. So this is mostly for me, but I hope it might be of interest to others, too.
...
[^1]: In the sense of Frankfurt's *On Bullshit* <http://www2.csudh.edu/ccauthen/576f12/frankfurt__harry_-_on_bullshit.pdf>
...
<i class="fa fa-user"></i> [Lengyi Han](https://cmps.ok.ubc.ca/about/contact/lengyi-han/), UBC
...
<i class="fa fa-user"></i> [Sam Caetano](https://www.statistics.utoronto.ca/people/directories/all-faculty/samantha-jo-caetano) (presenting), University of Toronto <i class="fa fa-twitter"></i> [\@StatisticalSam](https://twitter.com/StatisticalSam)

<i class="fa fa-twitter"></i> Also check out: [\@RohanAlexander](https://twitter.com/RohanAlexander), [\@michaelycchong](https://twitter.com/michaelycchong), [\@pailfodgetts](https://twitter.com/pailfodgetts)
...
<i class="fa fa-user"></i> [Douglas Whitaker](https://www.msvu.ca/academics/bachelor-of-science-bsc/mathematics/meet-our-faculty/douglas-whitaker/), Mount Saint Vincent University <i class="fa fa-twitter"></i> [\@DouglasWhitaker](https://twitter.com/douglaswhitaker)
...
<i class="fa fa-user"></i> [Nooshin Rotondi](https://healthsciences.ontariotechu.ca/people/faculty/nooshin-rotondi.php), Ontario Tech University
...
<i class="fa fa-user"></i> [Chris Holdgraf](), 2i2c.org, <i class="fa fa-twitter"></i> [\@choldgraf](https://twitter.com/choldgraf)
...
The rest of the session was hand on workshops from [David Liu](https://www.cs.toronto.edu/~david/), Nathan Taback (<i class="fa fa-twitter"></i> [\@NathanTaback](https://twitter.com/NathanTaback)) and [Nathaniel Stevens](https://uwaterloo.ca/statistics-and-actuarial-science/about/people/nstevens).  <https://github.com/ssc-datascience/pythonjupyter_wshop2021> They were really good!

There was a great discussion with all the panellists at the end about R vs Python \*shudder\*. Python is a more general programming language and is much more commonly used in data science, especially when it comes to putting it into production. Python is still (currently) weaker on some of the complex statistical tasks (e.g., advanced time series). For many purposes, both work well, but need to thoughtful about the context.

Nathaniel mentioned that some orgs are 'language agnostic', but that usually just applies to 'tinkering'. If you're putting things into a production pipeline, having them all in the same langauge tends to be better. 
