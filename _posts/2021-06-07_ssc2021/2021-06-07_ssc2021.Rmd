...
- We tend to have to make the assumption that, if we're only observing each person once, that their individual probability will be approcimates the group probability. This feels naughty. 
