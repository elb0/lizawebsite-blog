...
🔥 Hot tip! I just copied the data from the PDF, but saved some time on reformatting thanks to __multiple cursors__ in R Studio. A fun [trick for you to check out](https://www.r-bloggers.com/2019/04/rstudios-multiple-cursors-rule/).
