...
## Background^[_Guide to the Census of Population, 2016, Chapter 2 – Census history_ https://www12.statcan.gc.ca/census-recensement/2016/ref/98-304/chap2-eng.cfm]
...
Useful source: _Guide to the Census of Population, 2016, Chapter 2 – Census history_ https://www12.statcan.gc.ca/census-recensement/2016/ref/98-304/chap2-eng.cfm
...
- Prior to 2001 data was not collected on couples other than heterosexual couples.  
  - Notice the change from "live together as husband and wife" in the description of __common-law__ in 1996 to "live together as a couple" in 2021's description.
  - Older census forms don't account for common law relationships, and the heads of the house will always be men in a marriage ('wife' as a relationship to head option, but not never 'husband').
- For the 1951 census a new punch card technology was used make data tabulation faster. That is why the age is set up to record 10s and 1s in the way it is.
- Nunavut wasn't a territory until 1999 and so is not listed in the 1996 census.

What else did you notice? Let me know! [\@Liza_Bolton](https://twitter.com/Liza_Bolton)
